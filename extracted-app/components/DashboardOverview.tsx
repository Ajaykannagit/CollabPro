...
export function DashboardOverview() {
  ...
  const [requests] = useLoadAction(loadCollaborationRequestsAction, [], { status: null });
  const [projects] = useLoadAction(loadResearchProjectsAction, [], { searchQuery: null });
  const [challenges] = useLoadAction(loadIndustryChallengesAction, [], { searchQuery: null });
