      ...
      >
        ...
        <div className="p-4 border-t border-white/5 bg-black/20">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 bg-gradient-to-tr from-gray-600 to-gray-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg ring-2 ring-white/5">
              <User className="h-5 w-5" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-white truncate">Guest User</p>
              <p className="text-xs text-gray-500">Platform Access</p>
            </div>
          </div>
        </div>
      </motion.div>
        ...
        <div className="flex-1 overflow-auto custom-scrollbar p-6">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeSection === 'partners' && <CollegeProfiles onNavigate={setActiveSection} />}
