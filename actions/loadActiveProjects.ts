...
/**
 * Fetches active projects from the database with calculated metrics like budget utilization and milestone counts.
 * @returns {Promise<any>} An action object containing the query and metadata.
 */
...
export default loadActiveProjects;
